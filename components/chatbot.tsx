...
export default function Chatbot() {
  ...
  return (
    <>
      {/* Chatbot Icon */}
      {!isOpen && (
        <Button onClick={() => setIsOpen(true)} className="fixed bottom-5 right-5 rounded-full h-14 w-14 p-0 shadow-lg">
      ...
      {/* Chatbot Container */}
      {isOpen && (
        <Card className="fixed bottom-5 right-5 w-80 sm:w-96 h-96 shadow-lg flex flex-col z-50">
